...
async function showPopupCard(x: number, y: number, text: string, autoFocus: boolean | undefined = false) {
    ...
    if (!$popupCard) {
        ...
        $popupCard.style.fontSize = '0.813rem'
        $popupCard.style.color = '#333'
        $popupCard.style.font =
            '0.875rem/1.6 -apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji'
        const $container = await getContainer()
