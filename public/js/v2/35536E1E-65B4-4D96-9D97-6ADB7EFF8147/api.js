...
window.useUniqueArkoseSetupEnforcement = (enforcement) => {
    enforcement.setConfig({
        onCompleted: (/** @type {{ token: any; }} */ r) => {
            console.debug('enforcement.onCompleted', r)
            window.postMessage({ type: 'arkoseToken', token: r.token }, '*')
        },
        onReady: () => {
        ...
        Pe.on('challenge iframe', function (e) {
            ...
            if (Je.frame) {
                ...
                t && t !== Je.frame.style.width && ((Je.frame.style.width = t), (p = !0)),
                    ...
                    Je.mode === a &&
                        (r && r !== Je.frame.style['min-width'] && ((Je.frame.style['min-width'] = r), (p = !0)),
                        o && o !== Je.frame.style['min-height'] && ((Je.frame.style['min-height'] = o), (p = !0)),
                        i && i !== Je.frame.style['max-width'] && ((Je.frame.style['max-width'] = i), (p = !0)),
                        c && c !== Je.frame.style['max-height'] && ((Je.frame.style['max-height'] = c), (p = !0))),
                    p &&
                        Pe.emit(O, {
                            width: l,
                            height: u,
                ...
                return B(vt, 'config.mode') === a
                    ...
                    : ((vt.container = vt.bodyElement),
                      ...
                      vt.events.escapePressed ||
                          ((vt.events.escapePressed = Dt), window.addEventListener('keyup', vt.events.escapePressed)),
                      void (
                          vt.container &&
                          (vt.container.contains(vt.element) || (vt.container.appendChild(vt.element), Tt()))
                      ))
                    ...
                    (!(function (e) {
                        Pe.setup(e, A),
                            ...
                            vt.element &&
                                ...
                                (vt.element.getAttribute('class').match(e) || vt.element.setAttribute('class', dt(e)))
                    })(t.publicKey),
                    (i = t.publicKey),
